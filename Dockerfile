...
# FIX: Update all source paths to point to /app/frontend/dist
...
COPY --from=builder /app/frontend/dist/support.html backend/server/static/public/
COPY --from=builder /app/frontend/dist/app-sw.js backend/server/static/
COPY --from=builder /app/frontend/dist/workbox-*.js backend/server/static/
